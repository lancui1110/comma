  ...
  export default {
    ...
    methods: {
      ...
      changeSearchKeyword (e) {
        this.$store.commit('secHouse/setFilterSearch', { key: 'keyword', value: e.target.value })
        this.$store.dispatch('secHouse/searchEstate', e.target.value.trim())
      },
      hideTips () {
        this.$store.commit('secHouse/setFilterSearch', { key: 'tips', value: [] })
      },
      tipClick (item) {
        this.$store.commit('secHouse/setFilterSearch', { key: 'selectedTip', value: item })
        this.$store.commit('secHouse/setFilterSearch', { key: 'keyword', value: item.tipContent || item.estateName })
        this.hideTips()
